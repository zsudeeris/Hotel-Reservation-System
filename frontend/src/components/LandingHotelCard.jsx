...
export default function LandingHotelCard({ hotel }) {
  ...
  return (
    <div className="lh-card" onClick={() => navigate(`/hotels/${hotel.id}`)}>
      ...
      <div className="lh-card-body">
        ...
        <div className="lh-card-name">{hotel.hotel_name}</div>
        ...
        <div className="lh-card-footer">
          ...
          <button className="lh-card-btn" onClick={e => { e.stopPropagation(); navigate(`/hotels/${hotel.id}`) }}>
            View →
          </button>
        </div>
      </div>
